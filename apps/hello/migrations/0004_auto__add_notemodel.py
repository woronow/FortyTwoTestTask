...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NoteModel'
        db.create_table(u'hello_notemodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('inst', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('action_type', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1)),
        ))
        db.send_create_signal(u'hello', ['NoteModel'])


    def backwards(self, orm):
        # Deleting model 'NoteModel'
        db.delete_table(u'hello_notemodel')
