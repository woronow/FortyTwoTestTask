...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'hello_person', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.height'
        db.add_column(u'hello_person', 'height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, blank=True),
                      keep_default=False)

        # Adding field 'Person.width'
        db.add_column(u'hello_person', 'width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'hello_person', 'image')

        # Deleting field 'Person.height'
        db.delete_column(u'hello_person', 'height')

        # Deleting field 'Person.width'
        db.delete_column(u'hello_person', 'width')
    ...
    models = {
        ...
        u'hello.person': {
            ...
            'height': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'width': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'blank': 'True'})
        },
